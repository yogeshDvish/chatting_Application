...
//background
        ...
        JLabel  moreverte = new JLabel(i15);
        moreverte.setBounds(420, 20, 10, 30);
        p1.add(moreverte);
        ...
        a1.setBounds(5, 75, 440, 570);
         ...
         text1 = new JTextField();
          ...
          send.setBackground(new Color(7,95,84));
    ...
    public static void main(String[] args) {
        ...
        try{
            Socket s = new Socket ("192.168.57.1", 6001);
